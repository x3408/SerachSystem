...
public class Result implements Serializable{
    ...
    public  static final int SUCCESS_STATUS_CODE = 200; //成功状态码
    public  static final int NOTFIND_STATUS_CODE = 400; //未发现状态码
    public  static final int ERROR_STATUS_CODE   = 500; // 错误状态码
